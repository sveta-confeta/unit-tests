...
//01. cоздайте тип CityType (создали в соседнем файле и его импортировали)
//02. запоните обьект city ,чтобы тесты ниже прошли:

test('test city should contains 3 houses', () => {
    expect(city.houses.length).toBe(3); //значит внутри массива houses три обьекта
